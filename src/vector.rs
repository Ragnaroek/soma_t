...
impl Vec3f {
    ...
    pub fn copy(&self) -> Vec3f {
        return Vec3f::new(self.x, self.y, self.z);
    }
    ...
    pub fn normalize(&self) -> Vec3f {
        ...
        if norm.is_sign_positive() {
            let factor = 1.0 / norm.sqrt();
            return Vec3f::new(self.x * factor, self.y * factor, self.z * factor);
        }
        return self.copy();
    }
}
...
mod tests {
    ...
    #[test]
    fn test_copy() {
        assert_eq!(Vec3f::new_i32(1,2,3), Vec3f::new_i32(1,2,3).copy());
    }
    ...
    #[test]
    fn test_normalize() {
        assert_eq!(Vec3f::new_i32(0,1,0), Vec3f::new_i32(0,10,0).normalize());
        assert_eq!(Vec3f::new_i32(1,0,0), Vec3f::new_i32(40,0,0).normalize());
        assert_eq!(Vec3f::new_i32(0,0,1), Vec3f::new_i32(0,0,54).normalize());
        assert_eq!(Vec3f::new(0.8017837,0.26726124,0.5345225), Vec3f::new_i32(3,1,2).normalize())
    }
}
